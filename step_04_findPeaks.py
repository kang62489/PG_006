...
if os.path.exists(xlsx_filepath):
    ...
    set_df_1 ={}
    set_df_1['dfF0_ACSF'] = dfF0_ACSF
    set_df_1['dfF0_NEO'] = dfF0_NEO
    set_df_1['dfF0_Peaks'] = set_peaks.iloc[:, :5]
    
    set_df_2 = {}
    set_df_2['dfF0_ACSF_cal_zscores'] = dfF0_ACSF_cal_zscores
    set_df_2['dfF0_NEO_cal_zscores'] = dfF0_NEO_cal_zscores
    set_df_2['dfF0_Peaks_cal_zscores'] = set_peaks.iloc[:, 4:]

    results_0 = PlotResults(set_df_1, title_left=r"Peaks of ACSF_$\Delta F/F_0$", title_right=r"Peaks of NEO_$\Delta F/F_0$", ylim=[-0.5, 2])
    results_0.show()
    results_1 = PlotResults(set_df_2, title_left=r"Peaks of ACSF_zscored_$\Delta F/F_0$", title_right=r"Peaks of NEO_zscored_$\Delta F/F_0$", ylim=[-4, 8])
    results_1.show()
